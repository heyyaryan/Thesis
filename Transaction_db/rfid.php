		...
		<div class="container">
			...
			<div class="form-group">
				...
				<center>
					...
					<input type="text" name="search_text" id="search_text" placeholder="Search by RFID Number" class="form-control" />
					</center>
				</div>
			</div>
			<br />
		...
		<br />
			...
			<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
				<center><button onclick="printContent('result')">Print Transaction</button></center><br>
						<center><button type="submit" formaction="/Transaction_db/rfid.php">Reload</button></center><br>
...
<script type="text/javascript">
    ...
    function display_cdt() {
        ...
        // date part ///
        var dateUTC = dateObj;
        document.getElementById('cdt').innerHTML = dateUTC.toLocaleDateString("en-US", options);
        tt = refresh_cdt();
    }
    </script>		
<script>
