...
<html>
	...
	<body>
		<div class="container">
			<br />
			<center> <b>Search By Transaction ID</b></center>
			<br />
			<br />
			<div class="form-group">
				...
				<center>
					...
					<input type="text" name="search_text" id="search_text" placeholder="Search by Transaction ID" class="form-control" />
					</center>
				</div>
			</div>
			<br />
...
<hr>
		...
		<br />
			...
			<center><button onclick="printContent('result')">Print Transaction</button></center><br>
					<center><button type="submit" formaction="/Transaction_db/transactionid.php">Reload</button></center><br>
