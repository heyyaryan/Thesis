		...
		<div class="container">
			...
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" name="search_text" id="search_text" placeholder="Search by Transaction Date and Time" class="form-control" />
						</center>
				</div>
			</div>
			<br />
		...
		<br />
		 	...
		 	<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
				<center><button onclick="printContent('result')">Print Transaction</button></center><br>
						<center><button type="submit" formaction="/Transaction_db/transactiondatetime.php">Reload</button></center><br>
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"transactiondatetimefetch.php",
			method:"post",
			data:{query:query},
