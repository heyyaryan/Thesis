		...
		<div class="container">
			...
			<div class="form-group">
				...
				<center>
					...
					<input type="text" name="search_text" id="search_text" placeholder="Search by Transaction Type" class="form-control" />
					</center>
				</div>
			</div>
			<br />
...
<hr>
	...
	<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
		<center><button onclick="printContent('result')">Print Transaction</button></center><br>
				<center><button type="submit" formaction="/Transaction_db/transactiontype.php">Reload</button></center><br>
